...
export default function AuthPage({ onLoginSuccess, isLightMode, toggleTheme }) {
  ...
  const handlePhoneChange = (e) => {
    ...
    // Extract only the digits after +20
    const digitsAfter20 = value.slice(3).replace(/\D/g, "");
    // Limit to 10 digits after +20
    if (digitsAfter20.length > 10) {
      setPhoneError(
        "Please enter a valid phone number (+20 followed by 10 digits)",
      );
      return;
    }
    // Reconstruct the phone number
    const formattedPhone = "+20" + digitsAfter20;
    setPhone(formattedPhone);
    // Clear error if length is exactly 13 (+20 + 10 digits)
    if (formattedPhone.length === 13) {
      setPhoneError("");
    } else if (digitsAfter20.length > 0) {
      setPhoneError(
        "Please enter a valid phone number (+20 followed by 10 digits)",
      );
    }
    ...
    <div className="auth-wrapper animate-entrance">
      ...
      <div className="auth-split-grid">
        ...
        <div className="auth-left">
          ...
          <h1>
            Learn from <span className="highlight">real courses.</span>
            <br />
            <span className="highlight">track real progress.</span>
          </h1>

          <p>
            Program connects students with instructor-built courses — browse,
            enroll, watch lessons, and track your progress in one place.
          </p>
        </div>
        ...
        <div className="auth-right">
          <div className="auth-card glass-card">
            <div className="auth-header">
              ...
              <p>
                {isLogin
                  ...
                  : "Join Program and start your journey today"}
              </p>
            </div>
            ...
            <div className="auth-tabs">
              <div
                className={`tab-slider ${!isLogin ? "slide-right" : ""}`}
              ></div>
              <button
            ...
            {isOtpVerifying ? (
              <form
                className="auth-form animate-entrance"
                ...
                <div className="otp-header-wrapper">
                  ...
                  <div className="auth-actions">
                    ...
                    <button
                      ...
                      disabled={isCreatingAccount || otpCode.length !== 6}
                    >
                      {isCreatingAccount ? (
              ...
              <form className="auth-form" onSubmit={handleSubmit}>
                <div
                  className={`expandable-section ${!isLogin ? "expanded" : ""}`}
                >
                  <div className="expandable-content">
                    ...
                    <div className={`step-indicator ${stepDirection}`}>
                        ...
                        <div
                          ...
                          style={{
                            width:
                              registerStep === 1
                                ? "0%"
                                : role === "instructor" && registerStep === 2
                                  ? "100%"
                                  : registerStep === 2
                                    ? "50%"
                                    : "100%",
                      ...
                      {renderStepIcon(
                        2,
                        role === "instructor" ? "Profile" : "Academic",
                        <svg
                          width="18"
                          height="18"
                          viewBox="0 0 24 24"
                          ...
                          <>
                            ...
                            <div className="input-group">
                              ...
                              <div className="icon-input-wrapper">
                                ...
                                <input
                                  type="text"
                                  placeholder="e.g. Computer Science, AI, Full-Stack"
                                  required
                                  value={track}
                            ...
                            <div className="input-group">
                              ...
                              <div className="icon-input-wrapper">
                                ...
                                <input
                                  ...
                                  onChange={(e) =>
                                    setProvidedCourses(e.target.value)
                                  }
                                />
                              </div>
                            </div>
                        ...
                        <div className="vision-header">
                          ...
                          <div>
                            ...
                            <p className="vision-subtitle">
                              What do you hope to achieve with Program?
                            </p>
                          </div>
                        </div>
                      ...
                      {!isLogin && (
                        <div className="password-strength-container">
                          <div className="strength-bars">
                            <div
                              className={`strength-bar ${passStrength >= 1 ? "weak" : ""}`}
                            ></div>
                            <div
                              className={`strength-bar ${passStrength >= 2 ? "medium" : ""}`}
                            ></div>
                            <div
                              className={`strength-bar ${passStrength >= 3 ? "strong" : ""}`}
                            ></div>
                          </div>
                ...
                {isLogin && <a className="forgot-password">Forgot password?</a>}
                ...
                <div className="auth-actions">
                  ...
                  >
                    ...
                    ) : registerStep === (role === "instructor" ? 2 : 3) ? (
                      "Create Account"
                    ) : (
                      <>
                        Continue{" "}
