        ...
        <table className="admin-table" style={{ width: '100%', borderCollapse: 'separate', borderSpacing: '0 4px', textAlign: 'left' }}>
          <thead>
            <tr style={{ borderBottom: '1px solid var(--border)' }}>
              <th style={{ padding: '16px', fontWeight: 600, color: 'var(--c-sub)', fontSize: '0.85rem' }}>Student Info</th>
              <th style={{ padding: '16px', fontWeight: 600, color: 'var(--c-sub)', fontSize: '0.85rem' }}>Review</th>
